...
const zh: Record<string, string> = {
  ...
  'settings.comfyOutputDir': 'ComfyUI 输出目录（开播时自动清理旧 MotionContext latent，防串直播；留空自动探测）',
  'settings.comfyOutputDirPlaceholder': '如 D:\\ComfyUI\\output 或 D:\\Comfy-Desktop\\ComfyUI-Shared\\output',
...
const en: Record<string, string> = {
  ...
  'settings.comfyOutputDir': 'ComfyUI output dir (auto-clears old MotionContext latents on go-live to prevent cross-live mixing; auto-detect if empty)',
  'settings.comfyOutputDirPlaceholder': 'e.g. D:\\ComfyUI\\output or D:\\Comfy-Desktop\\ComfyUI-Shared\\output',
